...
instrcutorSchema.methods.matchPassword = async function (enteredPassword: string) {
...
const StudentModel: Model<ITUTOR> = model<ITUTOR>('instructorcollection', instrcutorSchema);
